...
TEST_F(PCLFunctionsTest, PCLToEigenTest)
{
  ...
  Eigen::Vector3f point_normal_converted =
    PCLFunctions::convertPCLtoEigen(point_normal);
  ...
  Eigen::Vector3f point_xyz_converted =
    PCLFunctions::convertPCLtoEigen(point_xyz);
  ...
  Eigen::Vector3f point_xyz_rgb_converted =
    PCLFunctions::convertPCLtoEigen(point_xyz_rgb);
...
TEST_F(PCLFunctionsTest, PCLNormalToEigenTest)
{
  ...
  Eigen::Vector3f point_normal_converted =
    PCLFunctions::convertPCLNormaltoEigen(point_normal);
...
TEST_F(PCLFunctionsTest, outliersTest)
{
  ...
  PCLFunctions::removeStatisticalOutlier(
    rectangle_cloud,
    0.5);
...
TEST_F(PCLFunctionsTest, extractPointCloudClustersTest)
{
  ...
  std::vector<pcl::PointIndices> indices =
    PCLFunctions::extractPointCloudClusters(rectangle_cloud, 0.005, 50);
