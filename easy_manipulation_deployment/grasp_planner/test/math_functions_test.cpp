...
TEST(MathFunctionTest, getAngleBetweenVectorsTest)
{
  ...
  float result = MathFunctions::getAngleBetweenVectors(vector_1, vector_2);
...
TEST(MathFunctionTest, getPointInDirectionTestPosDir)
{
  ...
  Eigen::Vector3f point_2 = MathFunctions::getPointInDirection(point_1, direction, 2.0);
...
TEST(MathFunctionTest, getPointInDirectionTestNegDir)
{
  ...
  Eigen::Vector3f point_2 = MathFunctions::getPointInDirection(point_1, direction, -3.1);
