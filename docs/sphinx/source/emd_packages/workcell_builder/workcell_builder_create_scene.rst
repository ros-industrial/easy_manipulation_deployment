...
In the drop-down menu, select the robot brand and model you would like to include in the work space

Origin
-----------------

The Origin is the positional and orientation coordinates values of the robot's **base link with respect to the World Link**. Un-checking the box defaults the XYZ and RPY coordinates to 0
...
The Origin is the positional and orientation coordinates values of the **end effector's base link with respect to the Robot's end effector link**. Un-checking the box defaults the XYZ and RPY coordinates to 0
