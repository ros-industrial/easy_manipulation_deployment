...
//    void PrintMaterial(Material material);
    ...
    void PrintEE(EndEffector ee)
    {
        ...
        std::cout<< " ================ Links ================"<<std::endl;
        for(int i = 0; i < int(ee.ee_links.size()); i++)
        {
    ...
    void PrintLink(Link link)
    {
        ...
        if(link.is_visual)
        {
            ...
            for(int visual = 0; visual < int(link.visual_vector.size()); visual++)
            {
        ...
        if(link.is_collision)
        {
            ...
            for(int collision = 0; collision < int(link.collision_vector.size()); collision++)
            {
        ...
        if(link.is_inertial)
        {
            ...
            for(int inertial = 0; inertial< int(link.inertial_vector.size()); inertial++)
            {
