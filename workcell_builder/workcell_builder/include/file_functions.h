...
void find_replace(std::string example_text, std::string target_text, std::string current_text, std::string replaced_text)
{
...
//void GenerateCMakeLists(boost::filesystem::path workcell_filepath,boost::filesystem::path package_filepath ,std::string package_name,int ros_ver)
void generate_cmakelists(boost::filesystem::path workcell_filepath,std::string package_name,int ros_ver)
{
    ...
    boost::filesystem::path example_file(example_path + "/ros" + std::to_string(ros_ver) + "/CMakeLists_example.txt");
...
void generate_package_xml(boost::filesystem::path workcell_filepath,std::string package_name,int ros_ver)
{
    boost::filesystem::path package_filepath(workcell_filepath.string() + "/scenes/" + package_name);
    std::string example_path = workcell_filepath.string() + "/easy_manipulation_deployment/workcell_builder/examples";
