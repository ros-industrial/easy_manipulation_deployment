...
#ifndef SCENE_CHECK_H
#define SCENE_CHECK_H
#include "workcell.h"
#include <iostream>
...
bool CheckSceneEqual(Scene scene_1, Scene scene_2)
{
    ...
    if(int(scene_1.robot_vector.size())!= int(scene_2.robot_vector.size()))
    {
        std::cout<<"robot_vector size not identical" <<std::endl;
        return false;
    }
    if(int(scene_1.object_vector.size())!= int(scene_2.object_vector.size()))
    {
        std::cout<<"object_vector size not identical" <<std::endl;
        return false;
    }
    if(int(scene_1.ee_vector.size())!= int(scene_2.ee_vector.size()))
    {
        std::cout<<"ee_vector size not identical" <<std::endl;
        return false;
    }
    if(int(scene_1.parent_objects.size())!= int(scene_2.parent_objects.size()))
    {
        std::cout<<"parent_objects size not identical" <<std::endl;
        return false;
    }
    if(int(scene_1.child_objects.size())!= int(scene_2.child_objects.size()))
    {
    ...
    {
        for(int i = 0; i < int(scene_1.object_vector.size()); i++)
        {
    ...
    {
        for(int i = 0; i < int(scene_1.robot_vector.size()); i++)
        {
    ...
    {
        for(int i = 0; i < int(scene_1.ee_vector.size()); i++)
        {
    ...
    {
        for(int i = 0; i < int(scene_1.parent_objects.size()); i++)
        {
    ...
    {
        for(int i = 0; i < int(scene_1.child_objects.size()); i++)
        {
...
bool CheckObjectEqual(Object object_1, Object object_2)
{
    ...
    if(int(object_1.link_vector.size())!= int(object_2.link_vector.size()))
    {
        return false;
    }
    if(int(object_1.joint_vector.size())!= int(object_2.joint_vector.size()))
    {
        return false;
    }

    for(int i = 0; i < int(object_1.link_vector.size()); i ++)
    {
    ...
    for(int i = 0; i < int(object_1.joint_vector.size()); i ++)
    {
...
bool CheckLinkEqual(Link link_1, Link link_2)
{
    ...
    if(int(link_1.visual_vector.size())!= int(link_2.visual_vector.size()))
    {
        return false;
    }
    if(int(link_1.collision_vector.size())!= int(link_2.collision_vector.size()))
    {
        return false;
    }
    if(int(link_1.inertial_vector.size())!= int(link_2.inertial_vector.size()))
    {
        return false;
    }
    if(link_1.visual_vector.size()> 0)
    {
        for(int i = 0; i < int(link_1.visual_vector.size()); i++)
        {
    ...
    {
        for(int i = 0; i < int(link_1.collision_vector.size()); i++)
        {
    ...
    {
        for(int i = 0; i < int(link_1.inertial_vector.size()); i++)
        {
...
bool CheckInertiaEqual(Inertial inertial_1, Inertial inertial_2)
{
    ...
    if(inertial_1.mass != inertial_2.mass|| inertial_1.ixx != inertial_2.ixx||inertial_1.ixy != inertial_2.ixy||inertial_1.ixz != inertial_2.ixz||inertial_1.iyy != inertial_2.iyy||inertial_1.iyz != inertial_2.iyz||inertial_1.izz != inertial_2.izz)
    {
        return false;
    }
    return true;
...
bool CheckOriginEqual(Origin origin_1, Origin origin_2)
{
    if (origin_1.x != origin_2.x ||origin_1.y != origin_2.y ||origin_1.z != origin_2.z ||origin_1.roll != origin_2.roll ||origin_1.pitch != origin_2.pitch ||origin_1.yaw != origin_2.yaw)
    {
        return false;
    }
...
bool CheckGeometryEqual(Geometry geometry_1, Geometry geometry_2)
{
    ...
    else
    {
        if(geometry_1.is_stl)
        {
            ...
            if(geometry_1.scale_x != geometry_2.scale_x||geometry_1.scale_y != geometry_2.scale_y||geometry_1.scale_z != geometry_2.scale_z)
            {
                return false;
            }
        }
...
bool CheckMaterialEqual(Material material_1, Material material_2)
{
    ...
    if(material_1.is_material)
    {
        ...
        {
            if(material_1.a != material_2.a ||material_1.r != material_2.r ||material_1.g != material_2.g ||material_1.b != material_2.b)
            {
                return false;
            }
        }
