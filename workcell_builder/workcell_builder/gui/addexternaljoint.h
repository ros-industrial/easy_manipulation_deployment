...
#ifndef ADDEXTERNALJOINT_H
#define ADDEXTERNALJOINT_H
...
public:
    ...
    std::vector<Object> available_objects; // Objects that can be connected to the target_object
